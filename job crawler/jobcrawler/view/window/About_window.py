...
class AboutWindowUI(object):
    ...
    def retranslateUi(self, AboutWindow):
        ...
        self.title.setText(_translate("AboutWindow", "Job Crawler - A propos", None))
        self.description.setText(_translate("AboutWindow", "<html><head/><body><p>Ce programme parcours différent job boards pour trouver de nouvelles annonces, à partir de listes de critères.</p><p>Les job boards utilisés sont: Aerocontact, Aeroemploiformation, Apec, CAOemploi, Indeed, Monster, Pôle emploi, Regionjob.</p><p>La recherche faite, l\'utilisateur peut ouvrir toutes les annonces dans son navigateur Internet.</p><p>Le programme exploite une base CSV pour stoquer les annonces parcourues.</p></body></html>", None))
